...
QQ_MEAN_MATCH_FILE=${HIST_VAR}-qdc-${SCALING}-${GROUPING}-ssr-${REFERENCE_QUANTILES}-mean-matched_day_${OBS_DATASET}-${MODEL}_${EXPERIMENT}_${RUN}_${REF_START}0101-${REF_END}1231.nc
