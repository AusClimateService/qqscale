...
TARGET_FILES := /g/data/xv83/agcd-csiro/tmin/daily/tmin_AGCD-CSIRO_r005_19100101-20220405_daily_time-chunked.zarr

AF_FILE=${HIST_VAR}-qdc-adjustment-factors-${METHOD}-${GROUPING}_day_${MODEL}_historical-${EXPERIMENT}_${RUN}_${HIST_START}0101-${HIST_END}1231_${REF_START}0101-${REF_END}1231.nc
QQ_BASE=${HIST_VAR}-qdc-${METHOD}-${GROUPING}_day_${OBS_DATASET}-${MODEL}_${EXPERIMENT}_${RUN}_${REF_START}0101-${REF_END}1231
