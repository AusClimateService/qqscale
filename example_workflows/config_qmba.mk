...
AF_FILE=${REF_FNAME_VAR}-${MAPPING}-${SCALING}-${GROUPING}-bias-vs-${OBS_DATASET}_AUS-15_CSIRO-BOM-ACCESS-CM2_historical_r4i1p1f1_BOM-BARPA-R_v1_day_${HIST_START}01-${HIST_END}12_AWAP.nc
