# Workflow for quantile mapping delta change of precipitation
...
${AF_PATH} : ${HIST_SSR_PATH} ${REF_SSR_PATH}
	${PYTHON} ${CODE_DIR}/calc_adjustment.py ${REF_VAR} ${HIST_VAR} $@ --hist_files $< --ref_files $(word 2,$^) --method ${METHOD} --verbose
